...
import static com.tencent.tencentclassroom.utils.Constant.FILESEPARATOR;
 ...
 * @author zhushuai$
 * 创建日期 2022/6/22$
 * @since com.tencent.tencentclassroom.download
 */
...
//        fixedThreadPool.shutdown();
    ...
    private void mergeTs() {
        try {
            File file = new File(mp4Dir + FILESEPARATOR + fileName + ".mp4");
            System.gc();
            if (file.exists()) {
                file.delete();
            } else {
